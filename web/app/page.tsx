        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center space-x-6">
              <Link href="#vision" className="text-text-tertiary hover:text-primary transition-colors text-sm">
                Vision
              </Link>
              <Link href="#subscribe" className="text-text-tertiary hover:text-primary transition-colors text-sm">
                Subscribe
              </Link>
            </nav>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <Link href="mailto:hello@markethawkeye.com" className="text-text-tertiary hover:text-accent transition-colors">
                Contact
              </Link>
